...
const fingerLookupIndices = {
  ...
  export const drawKeypoints = (ctx: CanvasRenderingContext2D, keypoints: Coords3D) => {
  ...
  function drawPath(ctx: CanvasRenderingContext2D, points: string | any[], closePath: boolean) {
